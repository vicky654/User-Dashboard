...
const ConsentTemplatesIcon:React.FC<{ width?: number; height?: number }> = ({ width = 40, height = 40 }) => {
    return (
        <>
            <svg width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg" xlinkHref="http://www.w3.org/1999/xlink">
                <rect width="30" height="30" fill="url(#pattern0_1722_11)" />
                <defs>
                    <pattern id="pattern0_1722_11" patternContentUnits="objectBoundingBox" width="1" height="1">
                        <use xlinkHref="#image0_1722_11" transform="scale(0.0111111)" />
                    </pattern>
                    <image
                        id="image0_1722_11"
                        width="90"
...
export default ConsentTemplatesIcon;
