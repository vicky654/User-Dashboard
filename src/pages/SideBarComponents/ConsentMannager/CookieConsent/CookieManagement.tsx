...
export default function CookieManagement() {
    ...
    const columns = [
        ...
        { header: t('Website'), accessor: 'website' },
    ];
    ...
    const filteredData = tableData.filter((row) => Object.values(row).some((val) => String(val).toLowerCase().includes(appliedSearch.toLowerCase())));
    ...
    return (
        <>
            <SelectHeader title="Cookie Management" showRiskLevel={false} />
            <CommonToolbar
                searchText={search}
